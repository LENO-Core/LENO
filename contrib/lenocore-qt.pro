...
RESOURCES += src/qt/lenocore.qrc src/qt/lenocore_locale.qrc

TRANSLATIONS += src/qt/locale/lenocore_bg.ts \
                src/qt/locale/lenocore_de.ts \
                src/qt/locale/lenocore_en.ts \
                src/qt/locale/lenocore_es.ts \
                src/qt/locale/lenocore_fi.ts \
                src/qt/locale/lenocore_fr.ts \
                src/qt/locale/lenocore_it.ts \
                src/qt/locale/lenocore_ja.ts \
                src/qt/locale/lenocore_pl.ts \
                src/qt/locale/lenocore_pt.ts \
                src/qt/locale/lenocore_ru.ts \
                src/qt/locale/lenocore_sk.ts \
                src/qt/locale/lenocore_sv.ts \
                src/qt/locale/lenocore_vi.ts \
                src/qt/locale/lenocore_zh_CN.ts \
                src/qt/locale/lenocore_zh_TW.ts
