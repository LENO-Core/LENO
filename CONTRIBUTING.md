Contributing to LenoCore
============================

The LenoCore project operates an open contributor model where anyone is
...
The following applies to code changes to the LenoCore project, and is not to be
confused with overall LenoCore Network Protocol consensus changes.

Whether a pull request is merged into LenoCore rests with the project merge
...
Patches that change LenoCore consensus rules are considerably more involved than
...
Where a patch set proposes to change the LenoCore consensus, it must have been
...
The project leader is the release manager for each LenoCore release.
