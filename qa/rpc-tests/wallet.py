...
#   c) node1 mines 32 blocks, so now node 0 has 60001LENO, node 1 has 4250LENO, node2 has none.
#   d) node0 sends 601 LENO to node2, in two transactions (301 LENO, then 300 LENO).
