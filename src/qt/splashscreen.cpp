...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextZNN = QChar (0xA9) + QString (" 2019-%1 ").arg (COPYRIGHT_YEAR) + QString (tr("The ZNN developers"));
    QString copyrightTextLenoCore = QChar (0xA9) + QString (" 2021-%1 ").arg (COPYRIGHT_YEAR) + QString (tr("The LenoCore developers"));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextZNN);
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextLenoCore);
