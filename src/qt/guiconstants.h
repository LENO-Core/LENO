...
/* LenoCore GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LenoCore"
#define QAPP_ORG_DOMAIN "lenocore.online"
#define QAPP_APP_NAME_DEFAULT "LenoCore-Qt"
#define QAPP_APP_NAME_TESTNET "LenoCore-Qt-testnet"
