...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LenoCore lenocore-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lenocore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lenocore transaction") + "\n" +
                               "  lenocore-tx [options] -create [commands]   " + _("Create hex-encoded lenocore transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lenocore transaction
