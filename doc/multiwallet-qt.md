...
In order to support loading of multiple wallets in lenocore-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lenocore.cpp.
...
Changes to lenocore.cpp
----------------------
lenocore.cpp is the entry point into lenocore-qt, and as such, will require some minor modifications to provide hooks for
