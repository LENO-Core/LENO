...
This mechanism has been integrated into Bitcore-Node-LenoCore which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LenoCore-Project/insight-api-lenocore#web-socket-api](https://github.com/LenoCore-Project/insight-api-lenocore#web-socket-api) 
* API: [https://github.com/LenoCore-Project/insight-api-lenocore#swifttx-transactions](https://github.com/LenoCore-Project/insight-api-lenocore#swifttx-transactions) 
...
By default, the LenoCore daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LenoCore daemon:
